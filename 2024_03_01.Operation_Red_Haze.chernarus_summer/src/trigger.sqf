...
player createDiaryRecord ["Diary", ["OTP Tutorial", "<p>OOC: (( The one-time pad (OTP) is a cryptographic technique to send messages. It involves using sheets with secret keys. If you read this you have found one. The sender and receiver both have the identical pads. To encode a message, the sender combines each letter of the plain text with the corresponding key number using the pad (use table at the bottom of the page A1-Z26).</p>
<br /><br />
<img image='img\ex_enc.jpg' /><br /><br />
